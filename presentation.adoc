...
image::images/mbse_with_a_docs_as_code_approach_for_the_sealion_cubesat_mission.jpeg[MBSE with a docs-as-code approach for the Sealion cubesate mission, 270, 374]
...
[.column]
--
image::images/lightsail_bread_loaf.jpg[Planetary Society's Lightsail compared to bread by Justin Jang, 501, 333]
Planetary Society's Lightsail compared to bread by Justin Jang
--

[.column]
--
image::images/lightsail.jpg[Lightsail artist concept by NASA Kennedy CC-BY-NC-ND-2.0, 640, 360]
...
* that light, although has no mass, has momentum that can be transferred to a reflective surface
* thus providing a means of propulsion for lightweight spacecrafts

--

=== CubeSats by Mission Type (2000-2021)

image::images/swartwout_data_graph.jpg[CubeSats by Mission Type (2000-2021), 624, 606]
...
image::images/mach_30_legacy_logo.png[Mach 30 Foundation logo, 823, 232]
...
image::images/fire_smoke_and_open_source_hardware.webp[Fire, Smoke, and Open Source Hardware, 640, 360]
...
image::images/oshwa_certified_projects.png[OSHWA Certified Projects, 752, 488]
...
image::images/oshwa_logo.jpg[OSHW logo, 500, 144]
...
https://github.com/dof-initiative

[.notes]
--
* Through a series of agile retrospectives, the Shepard team discovered that as the project grew in complexity, the description of the project became unmaintainable
...
[.column]
--
image::images/Git-Logo-1788C.svg[Git logo, 270]
image::images/Npm-logo.svg[NPM logo, 270]
--

[.column]
--
image::images/Yarn-logo-kitten.svg[Yarn logo, 270]
image::images/Gradle_logo.png[Gradle logo, 270]
image::images/jinjalogo.svg[Jinja logo, 270]
--
...
* Imagine running `npm install arduino-uno` and import all the description to be able to use an arduino-uno as a dependency in your project
...
image::images/n2chart_example.png[N2 chart example, 608, 462]
